...
//            ctx.addServletMappingDecoded("*.jpg", "default");
            ...
            // class文件读取地址
            File additionWebInfClasses = new File("springorigin/target/classes");
            // 创建WebRoot
            WebResourceRoot resources = new StandardRoot(ctx);
            // tomcat内部读取Class执行
            resources.addPreResources(
                    new DirResourceSet(resources, "/springorigin/WEB-INF/classes", additionWebInfClasses.getAbsolutePath(), "/"));
